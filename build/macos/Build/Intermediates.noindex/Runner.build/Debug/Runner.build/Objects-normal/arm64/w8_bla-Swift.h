...
#ifndef W8_BLA_SWIFT_H
#define W8_BLA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="w8_bla",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC6w8_bla11AppDelegate")
...
SWIFT_CLASS("_TtC6w8_bla17MainFlutterWindow")
